 ...
 * find_skills_and_tools re-fetches on demand if the agent references a skill whose
 * files were removed.
 */
...
export function formatAvailableSkillsPrompt(index: SkillIndex[]): string {
  ...
  // Usage instructions live in the find_skills_and_tools tool description (advertised
