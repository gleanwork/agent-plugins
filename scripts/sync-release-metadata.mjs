#!/usr/bin/env node
// Propagate canonical root release metadata into each shared plugin so every
...
const manifestPath = join(root, "shared/glean/mcp/package.json");
...
console.log(`synced version ${version} -> shared/glean/mcp`);
